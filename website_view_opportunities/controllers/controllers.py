...
class CustomerPortal(CustomerPortal):
    ...
    def portal_my_opportunities(self, page=1, date_begin=None, date_end=None, sortby=None, **kw):
        ...
        return request.render("website_view_opportunities.portal_my_opportunities", values)
    ...
    def portal_my_opportunity(self, opportunity_id=None, access_token=None, **kw):
        ...
        return request.render("website_view_opportunities.portal_my_opportunity", values)
